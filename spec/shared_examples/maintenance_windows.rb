...
RSpec.shared_examples 'maintenance_windows' do
  ...
  describe '#open_maintenance_windows' do
    ...
    it 'returns non-closed associated maintenance windows' do
      create(:unconfirmed_maintenance_window, factory => subject, id: 1)
      create(:confirmed_maintenance_window, factory => subject, id: 2)
      create(:closed_maintenance_window, factory => subject, id: 3)
